...
export const MOCK_GIVEAWAYS = [
  {
    ...
    prizeImage: '/assets/prizes/iphone-15-pro.jpg',
  ...
  },
  {
    ...
    prizeType: PRIZE_TYPES.PHYSICAL,
    prizeImage: '/assets/prizes/apple-watch-s9.jpg',
  ...
  },
  {
    ...
    prizeType: PRIZE_TYPES.PHYSICAL,
    prizeImage: '/assets/prizes/airpods-pro.jpg',
  ...
  },
  {
    ...
    prizeImage: '/assets/prizes/amazon-voucher.jpg',
    retailValueInr: 2000,
    entry: {
      currency: CURRENCIES.VES,
      amount: 500,
  ...
  },
  {
    ...
    title: '₹20 Amazon Micro-Voucher Pool',
    description:
      'High-probability daily reward pool! Spend your daily activity tokens to win instant micro-vouchers.',
    prize: '₹20 Amazon Pay Voucher',
    prizeType: PRIZE_TYPES.GIFT_CARD,
    prizeImage: '/assets/prizes/amazon-voucher.jpg',
    retailValueInr: 20,
    entry: {
    ...
    terms: '10 lucky winners will each receive a ₹20 voucher code directly inside the app.',
    claimType: CLAIM_TYPES.GIFT_CARD_CODE,
    isMock: true,
  },
];
...
export const MOCK_WINNERS = [
  ...
  },
  {
    ...
    giveawayTitle: '₹5,000 Amazon Gift Voucher',
    prize: '₹5,000 Amazon Pay E-Voucher',
    prizeType: PRIZE_TYPES.GIFT_CARD,
    prizeImage: '/assets/prizes/amazon-voucher.jpg',
  ...
  },
  {
    ...
    giveawayTitle: '₹2,000 Amazon Pay Card',
    prize: '₹2,000 Amazon Pay E-Gift Card',
    prizeType: PRIZE_TYPES.GIFT_CARD,
    prizeImage: '/assets/prizes/amazon-voucher.jpg',
